    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 7:
                ...
                console.log("===THROW THIS SHIT 2===");
                console.log(nerr.name, nerr.message, cmdRest);
                if (!(ctx.options.errorHandler != null)) return [3 /*break*/, 9];
                console.log("===THROW THIS SHIT 4===");
                console.log(nerr.name, nerr.message, cmdRest);
            ...
            case 28:
                ...
                if (ctx.options.errorHandler != null) {
                    console.log("===THROW THIS SHIT 3===");
                    console.log(err_1.name, err_1.message, cmd);
