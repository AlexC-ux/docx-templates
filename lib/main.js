        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    ...
                    reportXml = (0, xml_1.buildXml)(report1, xmlOptions).toString('utf-8');
                    if (_probe === 'XML')
                ...
                case 12:
                    ...
                    xml = (0, xml_1.buildXml)(report2, xmlOptions).toString('utf-8');
                ...
                case 17:
                    ...
                    if (numImages || numHtmls) {
                        ...
                        finalContentTypesXml = (0, xml_1.buildXml)(contentTypes, xmlOptions).toString('utf-8');
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                (0, zip_1.zipSetText)(zip, relsPath, finalRelsXml.toString('utf-8'));
                return [2 /*return*/];
        }
    });
}); };
