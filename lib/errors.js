...
var CommandExecutionError = /** @class */ (function (_super) {
    ...
    function CommandExecutionError(err, command) {
        var _this = this;
        console.info('===THROW THIS SHIT CommandExecutionError===');
        _this = _super.call(this, "Error executing command '".concat(command, "': ").concat(err.name, ": ").concat(err.message)) || this;
