        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 12:
                    ...
                    console.log("===THROW THIS SHIT002===");
                    console.log(nerr.name, nerr.message, code);
